...
CREATE TABLE hypotheses (
    hypothesis_id VARCHAR PRIMARY KEY,  -- 'HYP-2026-001'
...
│   ├── Run: "HYP-2026-003-v1" (params, metrics, artifacts)
│   ├── Run: "HYP-2026-003-v2-sensitivity"
│   └── Run: "HYP-2026-003-v3-robustness"
...
```sql
SELECT * FROM lineage
WHERE hypothesis_id = 'HYP-2026-003'
ORDER BY timestamp;
```
...
```markdown
# Validation Report: HYP-2026-003
...
├── docs/
│   ├── plans/
│   │   └── 2026-01-19-hrp-spec.md   # This specification
